...
def page_model(dataset):
    ...
    with tab1:
        ...
        # The button sits where the picker's label was, and links to the library;
        # the dropdown's own label is collapsed so nothing is said twice.
        col_b.button("Trajectory Signal \u2197", use_container_width=True,
