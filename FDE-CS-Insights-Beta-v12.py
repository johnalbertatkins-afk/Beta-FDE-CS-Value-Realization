...
def page_assumptions():
    ...
    st.write(f"The bands are calibrated assuming a company brings about {HISTORY_YEARS} "
             "years of usable renewal-trajectory history. That gives the 12-month horizon "
    ...
    st.markdown(
        "**Two-speed history.** The renewal backbone - consumption, engagement, "
        "relationship, support - can genuinely reach back four-plus years. The AI-native "
